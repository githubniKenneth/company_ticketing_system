...
?>
                ...
                <h2 class="my-5">Closed Tickets</h2>
            ...
            <table class="table" id="closedTicketsTable">
                <thead>
                <tr>
                    <th scope="col">#</th>
                ...
                <tbody>
                    <?php
                        $sql = "SELECT 
                        a.subject, a.ticket_description, a.date_created, a.message, a.ticket_id, a.priority, a.closed_by, a.assigned_to, a.date_closed,
                        ...
                        if($resultCheck > 0){
                            while($row = mysqli_fetch_assoc($result)){
                                ...
                                $date_closed_display = date_format($date_closed, "m/d/Y H:i A");
                                $closed = date_format($date_closed, "m/d/Y H:i:s");
                                $max_date = strtotime($closed);
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $date_closed_display; ?></td>
                                        <td><?php echo $days." days ".$hours." hours"?></td>
                                        ...
                                        <td><?php setFullName($closed_by); ?></td>
                                        <td class="">
                                            <button type="button" data-id="<?php echo $ticket_id; ?>" class="editTicket btn btn-primary  " <?php accessPermission("sa_view", $current_id, systemApps::appNum_ClosedTicket); ?>>Edit</button>
