    ...
    <table class="table">
        ...
        <?php
            if(isset($_POST["user"]))
            {
                ...
                {
                    ?>
                        <!-- <input type="text" id="selected_user" value="<?php echo $user;?>"> -->
                    <?php
                    $sql = "SELECT a.uar_code, a.sa_access, a.sa_add, a.sa_edit, a.sa_view, a.sa_delete, a.sa_print, a.sa_upload_doc, a.sa_download_doc, a.sa_delete_doc,
                            b.sa_name
